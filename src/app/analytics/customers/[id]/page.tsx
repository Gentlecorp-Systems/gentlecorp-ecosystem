  ...
  return (
    <Container maxWidth="md">
      ...
      >
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Stack spacing={1} sx={{ mt: 2 }}>
              ...
              />
              <InfoItem
                icon={maritalStatusMapping[customer.maritalStatus]?.icon}
                label="Ehestand"
                value={
                  maritalStatusMapping[customer.maritalStatus]?.label ||
              ...
              <InfoItem
                ...
                value={`${tierLevels[customer.tierLevel]?.icon} ${tierLevels[customer.tierLevel]?.label}`}
              />
              <InfoItem
                icon={
                  customer.subscribed ? (
                ...
                label="Abonniert"
                value={customer.subscribed ? "Ja" : "Nein"}
              />
              <Box display="flex" alignItems="center">
                <VerifiedUser sx={{ color: "#6A4BBC", mr: 1 }} />
                <Chip
                  label={customerStates[customer.customerState]?.label}
                  color={customerStates[customer.customerState]?.color}
                />
              </Box>
            </Stack>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Stack spacing={1} sx={{ mt: 2 }}>
              ...
              <Stack direction="row" spacing={1} sx={{ flexWrap: "wrap" }}>
                {customer.contactOptions?.map((option) => (
                  <Chip
                    key={option}
        ...
        {customer.contactIds && customer.contactIds.length > 0 ? (
          <Carousel
            arrows
            autoplay
            autoplaySpeed={3000}
            ...
            infinite={true}
          >
            {customer.contactIds.map((contact) => (
              <div key={contact._id?.$binary?.base64}>
                <Box sx={{ p: 2, display: "flex", justifyContent: "center" }}>
                  <Card sx={{ borderRadius: 3, boxShadow: 3, maxWidth: 350 }}>
                    <CardHeader
                      avatar={
